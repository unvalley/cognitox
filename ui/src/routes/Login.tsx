...
export function Login({ oauth, branding, error, navigate, setError }: Props) {
    ...
    <Card branding={branding}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div class="form-control mb-4">
          ...
          <input type="password" class="input input-bordered" value={password} onInput={e => setPassword((e.target as HTMLInputElement).value)} required disabled={submitting} autoComplete="current-password" />
        </div>
