//! AdminEnableUser API implementation
//!
...
mod tests {
    use super::*;
    use crate::action::user::{admin_create_user, admin_disable_user};
    use crate::action::user_pool::create_user_pool;
    use serde_json::json;

    #[tokio::test]
    async fn test_admin_enable_user_success() {
    ...
    #[tokio::test]
    async fn test_admin_enable_user_not_found() {
        let storage = Storage::new();
    ...
    #[tokio::test]
    async fn test_admin_enable_user_pool_not_found() {
        let storage = Storage::new();
